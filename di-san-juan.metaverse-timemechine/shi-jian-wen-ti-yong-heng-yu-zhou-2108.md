...
飞向未来世界，也同样可以，唯一不同的是，在原子宇宙的早期阶段，回到过去的 “平行宇宙”是状态确定的 ，飞向未来时间的 “平行宇宙” ，则是状态不可知的。



一切时间与循环悖论，例如：“穿越的你干掉了你的爷爷”，都是允许的，唯一不同的是，一切行为的后果和影响，都只发生在你穿越的**“平行宇宙”**。



原子宇宙分叉出无穷的 **“平行宇宙”**，就像一张无边无际的巨型 **“有向无环图 - DAG”，**在多维空间中无限的延展......
...
**注：**_有向无环图 ( DAG ) ：在图论中，如果一个有向图从任意顶点出发无法经过若干条边回到该点，则这个图是一个有向无环图。_
